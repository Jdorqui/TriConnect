...
{
    let fetchData = await fetch("http://169.254.97.236/PHP/TriConnect/Chatterly v0.5/php/login.php",
        {
            method: "POST",
...
{
    let fetchData = await fetch("http://169.254.97.236/PHP/TriConnect/Chatterly v0.5/php/chat.php",
        {
            method: "POST",
            headers: { "Content-Type": "application/x-www-form-urlencoded" },
...
{
    let fetchData = await fetch("http://169.254.97.236/PHP/TriConnect/Chatterly v0.5/php/verificarAmistad_Api.php",
        {
            method: "POST",
            headers: { "Content-Type": "application/x-www-form-urlencoded" },
...
{
    let fetchData = await fetch("http://169.254.97.236/PHP/TriConnect/Chatterly v0.5/php/usuarioNumero_Api.php",
        {
            method: "POST",
            headers: { "Content-Type": "application/x-www-form-urlencoded" },
...
{
    let fetchData = await fetch("http://169.254.97.236/PHP/TriConnect/Chatterly v0.5/php/numeroUsuario_Api.php",
        {
            method: "POST",
            headers: { "Content-Type": "application/x-www-form-urlencoded" },
